...
- [x] **BILL-01**: Trainer can start a 30-day free trial of Pro or Elite tier with no credit card required
...
- [x] **BILL-03**: Trainer can upgrade from Free or trial to a paid tier by entering payment details
- [x] **BILL-04**: Trainer can choose monthly or annual billing (annual = 20% discount, ~$7.20/mo Pro, ~$23.20/mo Elite)
- [x] **BILL-05**: Trainer can upgrade, downgrade, cancel, or update payment method via Stripe Customer Portal (no custom UI required)
...
- [x] **ADMN-02**: Admin can manually grant or revoke a tier override for any trainer without requiring a Stripe subscription
