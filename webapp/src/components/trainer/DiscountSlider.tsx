      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs uppercase tracking-[0.2em] text-ink/85 font-medium">Session Discount</p>
          </div>
          {value > 0 ? (
            <p className="text-sm text-ink/80">
              Clients see{' '}
              <span className="line-through text-ink/80">${optimizedRate}</span>
              {' → '}
            ...
            <p className="text-sm text-ink/80">No discount — full optimized rate applied</p>
          )}
        </div>
        <div className="text-right space-y-1">
          ...
          {value > 0 && (
            <p className="text-[10px] uppercase tracking-[0.1em] text-ink/85">off</p>
          )}
        </div>
      </div>
