  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-xs uppercase tracking-[0.2em] text-ink/85 font-medium">Intro Video</h3>
        {hasVideo && !uploading && (
          <button
      ...
      {hasVideo ? (
        ...
        >
          ...
          <div className="text-center">
            <p className="text-xs uppercase tracking-[0.2em] text-ink/80 group-hover:text-ink transition-colors">Upload Intro Video</p>
            <p className="text-[10px] text-ink/80 mt-1">MP4, WebM, or MOV — max 3 min, 300MB</p>
          </div>
        </button>
      )}
      ...
      {uploading && (
        <div className="space-y-2">
          ...
          <p className="text-[10px] uppercase tracking-[0.15em] text-ink/85">Uploading...</p>
        </div>
      )}
