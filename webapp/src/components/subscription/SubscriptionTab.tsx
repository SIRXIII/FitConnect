  ...
  if (isNativeiOS()) {
    return (
      <div className="space-y-6 text-center py-12">
        <p className="serif text-xl font-light italic text-ink">Your Plan</p>
        ...
        {tier === 'free' && (
          <p className="text-sm text-ink/85 max-w-xs mx-auto">
          ...
          {!trainerProfile?.cancel_at_period_end && (
            <div>
              <button
                ...
                className="text-ink/85 text-[11px] uppercase tracking-[0.2em] hover:text-red-600 transition-colors"
              >
                Downgrade to Free
              </button>
            </div>
