  ...
  return (
    <div className="border border-ink/10 p-8 space-y-6">
      <div className="flex items-center gap-2">
        ...
        <p className="text-xs uppercase tracking-[0.2em] text-ink/70 font-medium">Refer & Earn</p>
      </div>
      <div className="space-y-2">
        <p className="text-xs text-ink/60 font-light">Your referral code</p>
        <p className="text-2xl serif font-light text-ink tracking-[0.15em] uppercase">{referralCode}</p>
      </div>
      <div className="space-y-3">
        <p className="text-xs text-ink/60 font-light truncate">{referralLink}</p>
        <button
          onClick={handleCopy}
