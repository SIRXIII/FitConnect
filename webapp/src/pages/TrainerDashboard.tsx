      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          <div className="border border-ink/10 p-4 sm:p-8 space-y-3">
            <p className="text-[10px] sm:text-xs uppercase tracking-[0.2em] text-ink/85 font-medium">Upcoming Bookings</p>
            <p className="text-2xl sm:text-3xl serif font-light text-ink">{upcomingCount}</p>
          </div>
          <div className="border border-ink/10 p-4 sm:p-8 space-y-3">
            <p className="text-[10px] sm:text-xs uppercase tracking-[0.2em] text-ink/85 font-medium">Available Slots</p>
            ...
            {tier === 'free' && availableSlots <= 3 && availableSlots > 0 && (
              <p className="text-[10px] uppercase tracking-[0.2em] text-ink/85">
                All {availableSlots} visible — upgrade to show more
              </p>
            )}
          </div>
          <div className="border border-ink/10 p-4 sm:p-8 space-y-3">
            <p className="text-[10px] sm:text-xs uppercase tracking-[0.2em] text-ink/85 font-medium">Booked Slots</p>
            <p className="text-2xl sm:text-3xl serif font-light text-ink">{bookedSlots}</p>
          </div>
          <div className="border border-ink/10 p-4 sm:p-8 space-y-3">
            <p className="text-[10px] sm:text-xs uppercase tracking-[0.2em] text-ink/85 font-medium">Rating</p>
            ...
            {trainerProfile?.review_count ? (
              <p className="text-[10px] text-ink/80">{trainerProfile.review_count} reviews</p>
            ) : null}
          </div>
        </div>
        ...
        {trainerProfile && (
          <div className="border border-ink/10 p-8 flex flex-wrap gap-12">
            <div className="space-y-2">
              <p className="text-xs uppercase tracking-[0.2em] text-ink/85 font-medium">Standard Rate</p>
            ...
            {(trainerProfile.discount_percentage ?? 0) > 0 && (
              <div className="space-y-2">
                <p className="text-xs uppercase tracking-[0.2em] text-ink/85 font-medium">Session Rate</p>
                <p className="text-2xl serif font-light text-accent">
                  ...
                  <span className="text-[11px] text-ink/80 ml-2">({trainerProfile.discount_percentage}% off)</span>
                </p>
              </div>
            )}
            <div className="space-y-2">
              <p className="text-xs uppercase tracking-[0.2em] text-ink/85 font-medium">Specialty</p>
          ...
          <div className="border border-ink/10 p-8 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="space-y-1">
                <p className="text-xs uppercase tracking-[0.2em] text-ink/85 font-medium">Payment Setup</p>
        ...
        {trainerProfile?.availability_status === 'live' && trainerProfile?.booking_mode === 'request' && (
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <p className="text-[10px] uppercase tracking-[0.2em] text-ink/85">Pending requests from clients</p>
            </div>
            <BookingRequestQueue />
          </div>
        )}
        ...
        {trainerProfile && (
          <div className="border border-ink/10 p-8 space-y-6">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-xs uppercase tracking-[0.2em] text-ink/85 font-medium">Certifications</p>
