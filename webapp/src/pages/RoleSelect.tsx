    ...
    <div className="min-h-screen flex items-center justify-center bg-paper px-6">
      <div className="w-full max-w-2xl space-y-16 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div className={`transition-colors ${selected === 'trainer' ? 'text-accent' : 'text-ink/80 group-hover:text-ink/80'}`}>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-ink/85 leading-relaxed font-light">
          ...
          >
            <div className={`transition-colors ${selected === 'client' ? 'text-accent' : 'text-ink/80 group-hover:text-ink/80'}`}>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs uppercase tracking-[0.15em] text-ink/85 font-medium">
                Open to everyone
              </p>
            </div>
          </button>
