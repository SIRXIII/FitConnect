            ...
            >
              ...
              <div className="grid grid-cols-3 gap-12 pt-16 border-t border-ink/5">
                <div className="space-y-1">
                  <div className="text-2xl serif font-light italic">2026+</div>
                  <div className="text-[9px] uppercase tracking-widest text-ink/40">Professionals</div>
                </div>
                <div className="space-y-1">
                  <div className="text-2xl serif font-light italic">50%</div>
                  <div className="text-[9px] uppercase tracking-widest text-ink/40">Optimized Rate</div>
                </div>
                <div className="space-y-1">
